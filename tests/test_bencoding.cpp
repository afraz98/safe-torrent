...
#include "bencoding.cpp"

class BencodeParserTest : public ::testing::Test{
    TEST(BencodeParserTest, ParseStringTest) {
    ...
    TEST(BencodeParserTest, ParseStringEmptyInputTest) {
        Bencoding::BencodeParser parser;
        std::string input = "0:";
    ...
    TEST(BencodeParserTest, ParseStringInvalidInputTest) {
        Bencoding::BencodeParser parser;
    ...
    TEST(BencodeParserTest, ParseStringTooLongTest) {
        Bencoding::BencodeParser parser;
